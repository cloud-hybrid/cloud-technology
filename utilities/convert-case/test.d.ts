...
export interface Cloudformation {
  ...
  Resources: {
    ...
    [k: string]:
      ...
      | AWSEC2RouteTable
      | AWSEC2SecurityGroup
      | AWSEC2SecurityGroupEgress1
      | AWSEC2SecurityGroupIngress1
      | AWSEC2SpotFleet
      | AWSEC2Subnet
      ...
      | AWSElasticLoadBalancingV2ListenerCertificate1
